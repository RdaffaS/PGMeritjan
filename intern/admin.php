			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
                        <h1>PG Meritjan <br> Admin Dashboard</h1>
					</header>
                                ...
                                <tbody>
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <br><p><?=$motivational;?></p>
                                            <br><a href="<?=$linkedin;?>" class="button primary" target="_blank">Surat Pengantar</a> &nbsp <a href="<?=$portfolio;?>" class="button primary" target="blank">Surat Izin Ortu</a>
