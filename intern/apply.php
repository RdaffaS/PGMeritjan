			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
                        <h1>PG MERITJAN <br> PROGRAM MAGANG</h1>
						<p>Program magang ini memberikan kamu kesempatan untuk bekerja dalam tim <br> lintas departemen dalam mengerjakan sebuah projek tertentu.</p>
					</header>
					...
					<div id="main">
							...
							<section id="intro" class="main">
								<div class="spotlight">
									<div class="content">
                                        ...
                                        <p>Lokasi Kerja: <?=$jobloc;?></p>
                                        <p><?=$descjob;?></p>
									</div>
									<img src="img/pgmeritjan.jpg" class="landing" />
								</div>
							</section>
						...
						<!-- First Section -->
                            ...
                            <div class="row gtr-uniform">
                                                ...
                                                <div class="col-6 col-12-xsmall">
                                                    URL surat pengantar (Drive)
													<input type="url" name="linkedin" required>
												</div>
												<div class="col-6 col-12-xsmall">
                                                    URL surat izin ortu (Drive)
				...
				<!-- Footer -->
					<footer id="footer">
						<p class="copyright">PG Meritajan 2024</p>
					</footer>
